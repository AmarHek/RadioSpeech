...
export class EditStructureComponent implements OnInit, OnDestroy {
  ...
  onSubmitKat() {
    ...
    // this loop gets all the data from the input Form by the assigned IDs.
    // Empty Variables, Attributes and a Category are created and filled with
    // the input Form information.
