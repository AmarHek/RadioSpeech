...
scalacOptions ++= Seq(
  ...
  "-unchecked",                        // Enable additional warnings where generated judgement depends on assumptions.
  ...
  "-Ywarn-dead-judgement",                  // Warn when dead judgement is identified.
...
libraryDependencies ++= Seq(
  ...
  "org.docx4j"       % "docx4j-JAXB-MOXy" % "11.1.3",
