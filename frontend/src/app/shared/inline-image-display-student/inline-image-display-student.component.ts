...
@Component({
  ...
  templateUrl: "./inline-image-display-student.component.html",
  styleUrls: ["./inline-image-display-student.component.scss"]
})
export class InlineImageDisplayStudentComponent implements OnInit, OnChanges, AfterViewInit {
